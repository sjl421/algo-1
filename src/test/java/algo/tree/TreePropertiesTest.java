...
public class TreePropertiesTest {
  ...
  public void testHeight1() throws Exception {
    ...
    assertEquals("Empty tree", 0, TreeProperties.findHeight(tree.getRoot()));
    tree.insert(12);
    assertEquals("Only root", 1, TreeProperties.findHeight(tree.getRoot()));
    tree.insert(5, 9, 2, 17, 19, 18);
    assertEquals("longest path is 4 nodes", 4, TreeProperties.findHeight(tree.getRoot()));
  }
  ...
  public void testHeight2() throws Exception {
    ...
    assertEquals(4, TreeProperties.findHeight(root));
  }
