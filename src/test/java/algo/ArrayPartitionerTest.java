...
public class ArrayPartitionerTest {
    ...
    public void testPartitionNullArray() throws Exception {
        ArrayPartitioner.partition1(null);
    }

    @Test
    public void testPartition1() throws Exception {
        assertArrayEquals(new int[]{}, ArrayPartitioner.partition1(new int[]{}));
        assertArrayEquals(new int[]{10}, ArrayPartitioner.partition1(new int[]{10}));
        int[] actual = ArrayPartitioner.partition1(new int[]{3, 8, 2, 5, 1, 4, 7, 6});
